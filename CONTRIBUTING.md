...
- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/smartcl/fosite/blob/master/CODE_OF_CONDUCT.md)
...
[list of good first issues](https://github.com/smartcl/fosite/labels/good%20first%20issue).
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Convential Commits configuration](https://github.com/smartcl/fosite/blob/master/.github/workflows/conventional_commits.yml)
