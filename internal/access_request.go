...
// Source: github.com/smartcl/fosite (interfaces: AccessRequester)
//
...
func (m *MockAccessRequester) Merge(requester fosite.Requester) {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) Sanitize(allowedParameters []string) fosite.Requester {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) SetRequestedAudience(audience fosite.Arguments) {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) SetRequestedScopes(scopes fosite.Arguments) {
	m.ctrl.T.Helper()
...
func (m *MockAccessRequester) SetSession(session fosite.Session) {
	m.ctrl.T.Helper()
