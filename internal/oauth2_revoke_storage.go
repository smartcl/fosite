...
// Source: github.com/smartcl/fosite/handler/oauth2 (interfaces: TokenRevocationStorage)
//
...
import (
	...
	fosite "github.com/smartcl/fosite"
...
func (m *MockTokenRevocationStorage) CreateAccessTokenSession(ctx context.Context, signature string, request fosite.Requester) error {
	m.ctrl.T.Helper()
...
func (m *MockTokenRevocationStorage) CreateRefreshTokenSession(ctx context.Context, signature, accessSignature string, request fosite.Requester) error {
	m.ctrl.T.Helper()
...
func (m *MockTokenRevocationStorage) GetAccessTokenSession(ctx context.Context, signature string, session fosite.Session) (fosite.Requester, error) {
	m.ctrl.T.Helper()
...
func (m *MockTokenRevocationStorage) GetRefreshTokenSession(ctx context.Context, signature string, session fosite.Session) (fosite.Requester, error) {
	m.ctrl.T.Helper()
